...
const MovieCardDetails = () => {
  ...
  const apiSingleMovie = `https://api.themoviedb.org/3/movie/${id}?api_key=${apiCtx.apiKey}&language=en-US`;
  const apiMovieCredits = `https://api.themoviedb.org/3/movie/${id}/credits?api_key=${apiCtx.apiKey}&language=en-US`;

  const urls = [apiSingleMovie, apiMovieCredits];
